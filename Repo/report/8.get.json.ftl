		...
		<#list data as child>
{
			...
			"BatDauKetThuc":"<#if child.HoSo.properties["la:fo1p36"]??>${child.HoSo.properties["la:fo1p36"]}<#else>...</#if><#if child.HoSo.properties["la:fo1p37"]??>${child.HoSo.properties["la:fo1p37"]}<#else>- ...</#if>",
