//lamptt use: <import resource="classpath:/alfresco/templates/webscripts/zalu/vn/report/lib/lamptt.search.lib.js">
...
const DEFAULT_MAX_RESULTS = 250000;
...
function getRepositoryItem(folderPath, node)
{
       ...
       !(node.qnamePath.match(DISCUSSION_QNAMEPATH+"$") == DISCUSSION_QNAMEPATH))
   {
      ...
      if (node.isContainer)
      {
         ...
         item.size = -1;
         //lamptt
         item.f1 = ((tg =node.properties["sla:f1"]) !== null) ? tg : 0;
         item.f2 = ((tg =node.properties["sla:f2"]) !== null) ? tg : 0;
         item.f3 = ((tg =node.properties["sla:f3"]) !== null) ? tg : 0;
         item.f4 = ((tg =node.properties["sla:f4"]) !== null) ? tg : 0;
         item.f5 = ((tg =node.properties["sla:f5"]) !== null) ? tg : 0;
         item.f6 = ((tg =node.properties["sla:f6"]) !== null) ? tg : 0;
         item.f7 = ((tg =node.properties["sla:f7"]) !== null) ? tg : 0;
         item.mat2 = ((tg =node.properties["sla:mat2"]) !== null) ? tg : 0;
         item.mat3 = ((tg =node.properties["sla:mat3"]) !== null) ? tg : 0;
         item.mat4 = ((tg =node.properties["sla:mat4"]) !== null) ? tg : 0;
         item.fo1 = ((tg =node.properties["sla:fo1"]) !== null) ? tg : 0;
         item.fo2 = ((tg =node.properties["sla:fo2"]) !== null) ? tg : 0;
         item.fo3 = ((tg =node.properties["sla:fo3"]) !== null) ? tg : 0;
...
function getFolderbyName(nameFolder){
	var q = "{\"prop_cm_name\":\""+ nameFolder +"\",\"datatype\":\"cm:folder\"}";
	var params =
	{
		siteId: null,
		containerId: null,
